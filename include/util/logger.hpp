...
#define MF_LOG_EMIT(level, module, fmt, ...)                               \
    do {                                                                   \
        ::micro_forge::util::log_message((level), (module),                \
                                         (fmt)__VA_OPT__(, ) __VA_ARGS__); \
    } while (0)

#if MF_LOG_LEVEL <= MF_LVL_TRACE
#    define LOG_TRACE(module, fmt, ...)                           \
        MF_LOG_EMIT(::micro_forge::util::LogLevel::Trace, module, \
                    fmt __VA_OPT__(, ) __VA_ARGS__)
#else
...
#    define LOG_DEBUG(module, fmt, ...)                           \
        MF_LOG_EMIT(::micro_forge::util::LogLevel::Debug, module, \
                    fmt __VA_OPT__(, ) __VA_ARGS__)
#else
...
#    define LOG_INFO(module, fmt, ...)                           \
        MF_LOG_EMIT(::micro_forge::util::LogLevel::Info, module, \
                    fmt __VA_OPT__(, ) __VA_ARGS__)
#else
...
#    define LOG_WARN(module, fmt, ...)                           \
        MF_LOG_EMIT(::micro_forge::util::LogLevel::Warn, module, \
                    fmt __VA_OPT__(, ) __VA_ARGS__)
#else
...
#    define LOG_ERROR(module, fmt, ...)                           \
        MF_LOG_EMIT(::micro_forge::util::LogLevel::Error, module, \
                    fmt __VA_OPT__(, ) __VA_ARGS__)
#else
