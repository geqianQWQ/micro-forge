...
Expected<data_t> Stm32f1Timer::read(addr_t offset, Width w) {
    ...
    switch (offset) {
    case 0x00: return cr1_;
    case 0x0C: return dier_;
    case 0x10: return sr_;
...
Expected<void> Stm32f1Timer::write(addr_t offset, data_t data, Width w) {
    ...
    switch (offset) {
    case 0x00: cr1_  = data; return {};
    case 0x0C: dier_ = data; return {};
    case 0x10: sr_   = data; return {};
...
void Stm32f1Timer::tick(uint64_t cycles) {
    if (!(cr1_ & 0x0001)) return; // CEN not set
...
void Stm32f1Timer::set_prescaler(uint32_t psc) { psc_ = psc; }
void Stm32f1Timer::set_auto_reload(uint32_t arr) { arr_ = arr; }
uint32_t Stm32f1Timer::counter() const { return cnt_; }
bool Stm32f1Timer::update_flag() const { return (sr_ & 0x0001) != 0; }
void Stm32f1Timer::clear_update_flag() { sr_ &= ~0x0001u; }
