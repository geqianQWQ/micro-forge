...
Expected<data_t> Stm32f1Rcc::read(addr_t offset, Width w) {
    ...
    switch (offset) {
    case 0x00: return cr_;
    case 0x04: return cfgr_;
    case 0x08: return cir_;
    case 0x14: return ahbenr_;
    case 0x18: return apb2enr_;
    case 0x1C: return apb1enr_;
...
Expected<void> Stm32f1Rcc::write(addr_t offset, data_t data, Width w) {
    ...
    switch (offset) {
    case 0x00: cr_      = data; return {};
    case 0x04: cfgr_    = data; return {};
    case 0x08: cir_     = data; return {};
    case 0x14: ahbenr_  = data; return {};
    case 0x18: apb2enr_ = data; return {};
    case 0x1C: apb1enr_ = data; return {};
    default:   return std::unexpected(BusError::Fault);
    }
}
...
bool Stm32f1Rcc::is_clock_enabled(uint32_t peripheral_addr) const {
    ...
    if (peripheral_addr >= 0x40010000 && peripheral_addr < 0x40020000) {
        // GPIOA-C: bits 2-4, USART1: bit 14, TIM1: bit 11, ADC1: bit 9, AFIO: bit 0
